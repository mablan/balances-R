...
#' @param hrus lists List of rasters providing the definition of HRUs that will br stamped onto the classification regardless of its previous calculated value using the supplied cuts. Will be supplied in the order in which they are
										   ...
										   remove.areas=TRUE)
{
  ...
  if(order)
  {
    ...
    ords <- order(zonal.vals[ ,2], decreasing=T)
