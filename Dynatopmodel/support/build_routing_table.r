                               ...
                               len.fun=flow.lens,...)   #simple.dist.to.outlet)
{
  ...
  #     mean.lens <- sapply(split(len.tab, as.factor(lentab$reach)), function(tab){mean(tab$len)})
                                    ...
                                    chans=NULL)
{
  ...
  bins <- tabulate(cut(log(flow_dists[icell]), breaks=breaks.log, labels=F))
                                    ...
                                    chans=NULL)
{
  ...
  bins <- tabulate(cut(flow_dists[icell], breaks=breaks, labels=F))
