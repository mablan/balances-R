...
#' @param dev Integer. Device ID. Defaults to currently active device. If another valid device this will be activated. If not an existing device a new device will be opened.
#' @param ... Named list comprising any other valid graphics parameters
#'
