...
# 
# dt in second
#' Initalise run parameters
#'
#' @param start Start of run in format that can be coerced to a POSIXct
#' @param end 
#' @param dt Time step in s
#' @param tms A time series or an object that has a POSIXct index
#' @param ... 
#'
